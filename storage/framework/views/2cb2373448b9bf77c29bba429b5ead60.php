...
<input type="hidden"  value="<?php echo e($total=0); ?>
                            ...
                            <?php $__currentLoopData = \App\Models\Profit::where('user_id',auth()->user()->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($total+=$value->profits); ?>
...
<?php $__empty_1 = true; $__currentLoopData = $Photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
 <?php if(!$index): ?>
  <div class="carousel-item active">
      ...
      <img class="d-block w-100 "  src="<?php echo e(asset($onePhoto[0]->photo)); ?>"  alt="firist slide">

    </div>
<?php else: ?>
       <div class="carousel-item ">

      <img class="d-block w-100 " src="<?php echo e(asset($Photo->photo)); ?>" alt="Second slide">
 ...
 <?php endif; ?>
    ...
    <p class="assets-avatar"><img src='<?php echo e(asset("IMG/mony.jpg")); ?>' alt='' class='me-3' /><?php echo e(Auth::user()->name); ?></p>
    <hr>
    <div class="total-assets col-12">
        <h4 >My Total Assets</h4>
        <p><?php echo e(auth()->user()->scores->score); ?></p>
    </div>
    ...
    <div class='row'>
        <div class="box col-4 ">
            <div class="">
                ...
                <h6 class="fw-bold"><?php echo e($total); ?></h6>
            </div>
        </div>
        <div class="box col-4 ">
            <div class="">
               <h6 class="fw-bold">Promotion bonus</h6>
                            <h6 class="fw-bold"><?php echo e($Mony); ?></h6>
            </div>
        </div>
        <div class="box col-4 ">
            <div class="">
...
<hr />
<?php echo $__env->make('web.Icone.icone', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class='container text-left'>
 ...
 <?php if( Auth::user()->scores->score < $data->final_price): ?>
         <?php if( Auth::user()->scores->score >= $data->starting_price ): ?>

         <div class="Box col-md-6 col-lg-4 mt-2" >

            <div class="mt-1 IMG9 text-start" style="background-image: url('<?php echo e(asset($data->photo)); ?>')">

                <a href="<?php echo e(url('/step1/'.$data ->id)); ?>">
                    <p class="fw-bold">Required Amount: <?php echo e($data->starting_price); ?> ~ <?php echo e($data->final_price); ?> </p>
                    <p class="fw-bold">Income: <?php echo e($data->starting_income); ?> ~ <?php echo e($data->final_income); ?></p>
                </a>
        ...
        <div  class="Box col-md-6 col-lg-4 mt-2">
            ...
            <div class="mt-2  IMG9 text-start dataClose" style="background-image: url('<?php echo e(asset($data->photo)); ?>')">
        ...
        <div class="outer">
            <ul class="inner list-unstyled m-0 ">
                ...
                <li class="d-flex profile-profit">
                   ...
                   <p class="des-profit m-0 fw-bold"><?php echo e($user->name); ?> earns of  <?php echo e($user->score); ?>$</p>
                </li>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
...
<div class="modal mt-5 fade" id="turn" tabindex="-1" role="dialog" aria-labelledby="payLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content  bg-light">
            ...
            <form action="<?php echo e(route('TransferMony')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
$value.addEventListener("input",function(){
    document.querySelector('#Mony').value=$value.value-($value.value * (<?php echo e($tax); ?>/100));
})
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monyboxs.com/public_html/resources/views/web/home.blade.php ENDPATH**/ ?>