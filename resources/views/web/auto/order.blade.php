...
@section('main')
        ...
        <div class='container text-center'>
            ...
            <p class=''>Constract Content</p>
            {{-- <p class=''>Number of orders per day: <span>28</span></p> --}}
            <p class=''>purchasing price: <span>{{$data->price}}</span></p>
            <p class=''>Validity Period: <span>{{$data->time_end*24}} hr</span></p>
            <div class='row1'>
                <a type="button"
                    class='Step mb-2 w-50 p-1 mt-2 text-white d-flex align-items-center justify-content-center' data-toggle="modal" data-target="#model1">Join the contact</a>
            </div>
    ...
    <div class="modal mt-5 fade" id="model1" tabindex="-1" role="dialog" aria-labelledby="model1Label"
        ...
        <div class="modal-dialog" role="document">
            ...
            <a type="submit" id="submitButton" href="{{route('autodataindex',$data->id)}}"  class="btn  Step"
