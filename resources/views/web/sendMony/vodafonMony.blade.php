    ...
    <div class="container">
      <div class="web-home-content assets-card py-5 m-0">
        ...
        <div class="sendcash-content">
          <div class="text-center">اختر حسابًا </div>
         <form>
          <label>المستلم</label>
          <input type="text" value="أسم المستلم " class="input-group readonly" readonly>
           <label class="my-3">أختر حسابك</label>
           <a class="add-newaccount mt-3  d-block text-center" data-toggle="modal" data-target="#newAccount"> <span class="ml-2">اضافه حساب جديد</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#5310bf" class="bi bi-plus-lg" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
            </svg>
          </a>
           <a class="btn follow-btn mt-5" href="{{url('/vodafonSend')}}">مُتابعة</a>
          </form>
          </div>
        </div>
      </div>
