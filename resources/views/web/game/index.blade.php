...
@section('main')
  ...
  <div class="main-content">
    <div class="container">
      <div class="web-home-content assets-card py-2 m-0">
            <div class="d-flex flex-wrap justify-content-between">
              <div class="game-item"  data-toggle="modal" data-target="#game-detalis" >
                <img src="https://www.monyboxs.com/upload/logo/1785290857286257.jpg" class="game-img">
   ...
   <div class="modal slide-bottom" id="game-detalis" tabindex="-1" aria-labelledby="staticBackdropLabel"
        aria-hidden="true">
        <div class="modal-dialog">
           ...
           <div class="game-back d-flex text-center" data-toggle="modal" data-target="#gameDetalis">
          ...
          <div class="modal-content">
              ...
              <div class="sendcash-content ">
                  <div class="d-flex flex-wrap justify-content-between">
              <div class="game-package d-flex" data-toggle="modal" data-target="#gameDetalis">
                <img src="game.png" class="game-img">
                <div>
                  <h6>شحن ببجى [60 شدات ]] - مباشر</h6>
    ...
    <div class="modal slide-bottom" id="gameDetalis" tabindex="-1" aria-labelledby="staticBackdropLabel"
      aria-hidden="true">
      <div class="modal-dialog assets-card container"> <div class="d-flex align-items-center justify-content-between pb-2">
          <strong>شحن ببجى [60 شدات ]] - مباشر</strong>
          <div class="close" data-dismiss="modal" aria-label="Close">
            <svg fill="textThird" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="bn-svg" width="20"
              height="20">
              <path
        ...
        <div class="modal-content">
          <form class="sendcash-content choose-form">
            <input type="text" class="input-group" placeholder="رقم اللاعب">
               <div class="group-btn mt-3">
              <a  class="btn back-color" data-toggle="modal" data-target="#confirmation" data-dismiss="modal"  aria-label="Close"> شراء</a>
